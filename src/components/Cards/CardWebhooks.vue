	...
	<a-card :bordered="false" class="header-solid h-full" :bodyStyle="{paddingTop: 0, paddingBottom: '16px' }">
		...
		<a-row :gutter="[24, 24]">
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Event: Asset Created" :column="1">
					</a-descriptions>
				</div>
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Event: Asset Deleted" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Event: Asset Checked In" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Event: Asset Checked Out" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Event: Project Overdue" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
