<template>
	...
	<a-card :bordered="false" class="header-solid h-full" :bodyStyle="{paddingTop: 0, paddingBottom: '16px' }">
		<template #title>
			<h6 class="font-semibold m-0">Installed Connections</h6>
		</template>
		<a-row :gutter="[24, 24]">
			<a-col :span="24">
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="JitBit Helpdesk" :column="1">
						<a-descriptions-item label="API Key">
							eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEzMzUsImFkZ...
						</a-descriptions-item>
						<a-descriptions-item label="Endpoint URL">
							https://support.engineering.oregonstate.edu/api
						</a-descriptions-item>
					</a-descriptions>
				</div>
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Barcode Scanner" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
			...
			<a-card :bordered="false" class="card-billing-info">
				<div class="col-info">
					<a-descriptions title="Label Printer" :column="1">
					</a-descriptions>
				</div>
				<div class="col-action">
					<a-button type="link" size="small">
